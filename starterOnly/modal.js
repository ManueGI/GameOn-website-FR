...
form.addEventListener("submit", (event) => {
  if (!validate()) {
    ...
    const modalSuccess = getElement("modalsuccess")
     ...
     // Get heights
     const modalBgHeight = modalbg.offsetHeight;
     const formHeight = form.offsetHeight;

     // Apply heights
     modalSuccess.style.height = modalBgHeight + "px";
     modalSuccess.querySelector(".content").style.height = formHeight + "px";

    modalSuccess.style.display="block"
    closeModal();

    console.log("success");
    const closeSuccessModal = getElement('closemodalsuccess');
